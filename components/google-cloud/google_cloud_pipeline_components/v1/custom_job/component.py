...
def custom_training_job(
  ...
  Args:
      ...
      display_name: The name of the custom training job.
      ...
      restart_job_on_worker_restart: Restarts the entire
        ...
        joining a job.
      service_account: Sets the default service account for
      ...
      tensorboard: The name of a Vertex AI Tensorboard resource
        to which this CustomJob will upload Tensorboard logs.
      enable_web_access: Whether you want Vertex AI to enable
        [interactive shell
      ...
      network: The full name of the Compute Engine network to
      ...
      reserved_ip_ranges: A list of names for the
